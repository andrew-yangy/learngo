module github.com/ddvkid/learngo

go 1.17

require (
	github.com/aws/aws-sdk-go-v2/config v1.12.0
	github.com/aws/aws-sdk-go-v2/service/kafka v1.13.0
...
require (
	...
	github.com/segmentio/kafka-go/sasl/aws_msk_iam v0.0.0-20220104182514-37ab7b1b613c // indirect
